...
void gameplay(char tabuleiro_original_jogador1[8][26], char tabuleiro_original_jogador2[8][26], int novo_jogo){
    ...
    if(novo_jogo == 1){
        f1 = fopen("Campo_Jogador1.txt", "w");                                      // lembrar que quando for passar o arquivo pra header colocar o endereço.
        ...
        f1 = fopen("Campo_Jogador1.txt", "r");
        f2 = fopen("Campo_Jogador2.txt", "r");
        for(int i = 7; i >= 0; i--){
        ...
        f3 = fopen("InformacoesParaSalvamento.txt", "r");
...
/*      ORDEM PARA SALVAMENTO
    ...
    do{
        ...
        do{
            ...
            scanf(" %d", &salvar);
                ...
                fclose(f2);
                f3 = fopen("InformacoesParaSalvamento.txt", "w");
                /*      ORDEM PARA SALVAMENTO
                Acertos jogador1: %d
                Erros jogador1: %d
                Pirata: %d
    ...
    strcpy(tabuleiro_jogador1[7], ".  P  .  .  .  .  .  .  8");
    strcpy(tabuleiro_jogador1[6], ".  P  .  .  C  C  .  .  7");
    strcpy(tabuleiro_jogador1[5], ".  P  .  .  .  .  .  .  6");
    strcpy(tabuleiro_jogador1[4], ".  P  .  .  .  B  .  .  5");
    strcpy(tabuleiro_jogador1[3], ".  P  .  .  .  B  .  .  4");
    strcpy(tabuleiro_jogador1[2], ".  .  .  .  .  B  .  .  3");
    strcpy(tabuleiro_jogador1[1], ".  .  .  .  .  .  .  .  2");
    strcpy(tabuleiro_jogador1[0], ".  .  V  V  V  V  .  .  1");

    strcpy(tabuleiro_jogador2[7], ".  .  .  .  .  .  .  .  8");
    strcpy(tabuleiro_jogador2[6], ".  B  B  B  .  V  .  .  7");
    strcpy(tabuleiro_jogador2[5], ".  .  .  .  .  V  .  .  6");
    strcpy(tabuleiro_jogador2[4], ".  .  C  C  .  V  .  .  5");
    strcpy(tabuleiro_jogador2[3], ".  .  .  .  .  V  .  .  4");
    strcpy(tabuleiro_jogador2[2], ".  .  .  .  .  .  .  .  3");
    strcpy(tabuleiro_jogador2[1], ".  .  .  .  .  .  .  .  2");
    strcpy(tabuleiro_jogador2[0], ".  P  P  P  P  P  .  .  1");
        gameplay(tabuleiro_jogador1, tabuleiro_jogador2, 0);
    }
